...
/>
     ...
     <button
      onClick={hendlegoogle}
        ...
        type="button"
        className="w-full flex cursor-pointer font-bold bg-white rounded-lg mt-3 items-center text-2xl justify-center"
      >
        <img className='w-10' src="src/assets/images.png" alt="" />
       Google
      </button>
  </div>
</>
